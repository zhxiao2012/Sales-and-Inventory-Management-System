...
namespace EMS.BaseClass
{
    internal class DataBase : IDisposable
    {
        ...
        private void Open()
        {
            ...
            {
                con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Administrator\\source\repos\\erp\\Database\\db_EMS.mdf;Integrated Security=True;Connect Timeout=30"); //创建数据库连接对象
            }
